...
crystal:{
  ...
  /* Сцена — решётка в условном масштабе: между атомами доли нанометра.
...
fermi:{
  ...
  /* Сцена — диаграмма уровней энергии, по осям не метры. Поэтому ни осей с
...
binding:{
  ...
  /* Сцена — график энергии связи от массового числа. Поэтому ни осей с
     числами, ни надписи «сетка N м». */
  schema:true,
  /* Время здесь ни на что не влияет: показания и графики от него не
     зависят. Движение на сцене — иллюстрация процесса, а не его ход во
...
antimatter:{
  ...
  /* Сцена — схема аннигиляции: частицы и фотоны нарисованы условно. Поэтому
