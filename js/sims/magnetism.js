...
battery:{
  ...
  /* Сцена — схема цепи: метров на ней нет. Поэтому ни осей с числами, ни
     надписи «сетка N м». */
  schema:true,
  params:[
...
magmat:{
  ...
  /* Сцена — кусок вещества в условном масштабе: домены рисуются по клеткам,
     а не по метрам. Поэтому ни осей с числами, ни надписи «сетка N м». */
  schema:true,
  params:[
...
generator:{
  ...
  /* Сцена — схема машины: рамка, катушка и трансформатор нарисованы условно.
